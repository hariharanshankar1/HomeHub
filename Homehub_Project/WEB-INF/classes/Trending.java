...
public class Trending extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest request,
        ...
        pw.print("<a style='color:#E78200; font-family: Comic Sans MS, cursive, sans-serif; font-weight:bold; font-size: 24px;'>Top 5 most liked products</a>");
        ...
        pw.print("<div id='content'><div class='post'><h2 class='title meta'>");
        pw.print("<a style='color:#E78200; font-family: Comic Sans MS, cursive, sans-serif; font-weight:bold; 'font-size: 6px;'>Top 5 zip-codes where maximum number of products sold</a>");
        pw.print("</h2><div class='entry'><table id='bestseller'>");
        ...
        pw.print("<div id='content'><div class='post'><h2 class='title meta'>");
        pw.print("<a style='color:#E78200; font-family: Comic Sans MS, cursive, sans-serif; font-weight:bold; 'font-size: 24px;'>Top 5 most sold products regardless of the rating</a>");
        pw.print("</h2><div class='entry'><table id='bestseller'>");
