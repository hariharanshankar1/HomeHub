									  ...
									  String userStreet, String userCity, String userState, String userZipcode, String productrebate) 
	{
        try 
		{
            ...
            BasicDBObject doc = new BasicDBObject("title", "myReviews").
					...
					append("userStreet", userStreet).
					append("userCity", userCity).
					append("userState", userState).
					append("userZipcode", userZipcode).
        ...
        try 
		{
			...
			while (cursor.hasNext()) 
			{
                ...
                Review review = new Review(obj.getString("productName"), obj.getString("userName"), obj.getString("productType"),
                        ...
                        obj.getString("retailerpin"), obj.getString("price"), obj.getString("retailercity"), obj.getString("userAge"), obj.getString("userGender"), obj.getString("userOccupation"), obj.getString("userStreet"), obj.getString("userCity"), obj.getString("userState"), obj.getString("userZipcode"), obj.getString("productrebate"));
