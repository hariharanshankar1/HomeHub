...
public class DataAnalytics extends HttpServlet 
{
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException 
	{
		...
		pw.print("<a style = 'font-family: Comic Sans MS, cursive, sans-serif; font-weight:bold; color:#E78200'; font-size: 24px;'>Data Analytics on Review</a>");
		...
		pw.print("<td>");
		pw.print("<input type='text' name='productName'>");
		pw.print("</td>");
			pw.print("<tr>");
			     pw.print("<td> <input type='checkbox' name='queryCheckBox' value='Price'> Select </td>");
                                pw.print("<td> Service Price: </td>");
                              pw.print(" <td>");
			...
			pw.print("<tr>");
				...
				pw.print("<tr><td>");
					pw.print("<input type='checkbox' name='extraSettings' value='GROUP_BY'> Group By");
                                ...
                                pw.print("<option value='GROUP_BY_PRODUCT'>Service Name</option>");
                                pw.print("</td><td>");
