...
public class StoreManagerHome extends HttpServlet 
{
	...
	protected void displayLogin(HttpServletRequest request, HttpServletResponse response, PrintWriter pw, boolean error) throws ServletException, IOException 
	{
		...
		pw.print("<form method='get' action='ProductModify'>"
				...
				+ "<input type='submit' class='btnbuy' name='button' value='AddService'style = 'font-size:50px'></input>"
				+ "</td></tr><tr><td></td></tr><tr><td>"
				+ "<input type='submit' class='btnbuy' name='button' value='UpdateService' style = 'font-size:50px'></input>"
				+ "</td></tr><tr><td></td></tr><tr><td>"
				+ "<input type='submit' class='btnbuy' name='button' value='DeleteService' style = 'font-size:50px'></input>"
				+ "</td></tr><tr><td></td></tr>"
